        ...
        return (
            <span>
                ...
                { this.props.work.map( (example, i) =>{
                    return (
                        <ExampleWorkBubble example={example} key={i} openModal={this.openModal}/>
                    )
                })}
                </section>
...
class ExampleWorkBubble extends React.Component {
    ...
    render() {
        ...
        return (
            <div onClick={ (event) => this.props.openModal(event, example)} className="section__exampleWrapper">
